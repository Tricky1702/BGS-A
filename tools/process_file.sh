...
sed -e "s/[$]AUTHOR[$]/$AUTHOR/" -e "s/[$]COPYRIGHT[$]/$COPYRIGHT/" -e "s/[$]LICENSE[$]/$LICENSE/" -e "s/[$]LICENSE_FULL[$]/$LICENSE_FULL/" -e "s=[$]LICENSE_URL[$]=$LICENSE_URL=" -e "s/[$]VERSION[$]/$VERSION/" < $2 > $2.new
mv $2.new $2
